...
import com.haram3rbat.tanaqol.uiMotabara.MainMotabaraActivity;

import java.util.HashMap;
import java.util.concurrent.TimeUnit;

public class OTPMotabaraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otpmotabara);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            reference.child(deviceID).updateChildren(map)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(OTPMotabaraActivity.this, "تم تسجيل الدخول بنجاح", Toast.LENGTH_SHORT).show();
                                                Intent i = new Intent(OTPMotabaraActivity.this, MainMotabaraActivity.class);
                                                startActivity(i);
                                                finish();
                                            } else {
                                                Toast.makeText(OTPMotabaraActivity.this, "Error" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                        } else {
                            ...
                            Toast.makeText(OTPMotabaraActivity.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(OTPMotabaraActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
