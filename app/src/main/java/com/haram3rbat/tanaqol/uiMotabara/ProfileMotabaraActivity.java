...
public class ProfileMotabaraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_profile_motabara );
        ...
        progressDialog=new ProgressDialog ( ProfileMotabaraActivity.this );
    ...
    private void clickListener()
    {
        edit_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ProfileMotabaraActivity.this, EditProfileMotabaraActivity.class));
            }
        });
        ...
        logoutTv.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProfileMotabaraActivity.this, splash.class);
        ...
        redeemHistoryTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ProfileMotabaraActivity.this, OrdersMotabaraActivity.class));
            }
        });
        ...
        camera.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View v) {
                Dexter.withContext ( ProfileMotabaraActivity.this )
                        ...
                        .withListener ( new MultiplePermissionsListener () {
                            ...
                            public void onPermissionsChecked(MultiplePermissionsReport multiplePermissionsReport) {
                                ...
                                {
                                    Toast.makeText ( ProfileMotabaraActivity.this, "برجاء تفعيل الأذونات", Toast.LENGTH_SHORT ).show ();
                                }
                            }
        ...
        storageReference.putFile ( photoUri )
                .addOnSuccessListener ( new OnSuccessListener<UploadTask.TaskSnapshot> () {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText ( ProfileMotabaraActivity.this, "Error"+e.getMessage (), Toast.LENGTH_SHORT ).show ();
                    }
    ...
    private void getDataFromDatabase() {
        reference.child (deviceID).addValueEventListener ( new ValueEventListener () {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText ( ProfileMotabaraActivity.this, "Unable to fetch data"+error.getMessage (), Toast.LENGTH_SHORT ).show ();
                finish ();
            }
        } );
    }
