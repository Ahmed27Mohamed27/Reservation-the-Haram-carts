...
public class EditProfileMotabaraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_profile_motabara);
    ...
    private void get_data() {
        ...
        reference.child (deviceID).addValueEventListener ( new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText ( EditProfileMotabaraActivity.this, "Unable to fetch data"+error.getMessage (), Toast.LENGTH_SHORT ).show ();
                finish ();
            }
        } );
        ...
        reference.child(deviceID).updateChildren(map)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Toast.makeText(EditProfileMotabaraActivity.this, "تم تعديل بياناتك", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
